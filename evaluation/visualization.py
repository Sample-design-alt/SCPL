...
if model=='SemiCOP':
    ...
    ckpt_backbone = r'/data/chenrj/semi-order-time/ckpt/exp-cls/supervised/CricketX/magnitude_warp_time_warp/label1/1/backbone_best.tar'
    ckpt_cls_head = r'/data/chenrj/semi-order-time/ckpt/exp-cls/supervised/CricketX/magnitude_warp_time_warp/label1/1/classification_head_best.tar'
