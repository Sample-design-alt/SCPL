...
ckpt_backbone = r'/data/chenrj/semi-order-time/ckpt/exp-TSC/SemiSOP/EpilepticSeizure/magnitude_warp_time_warp/label1_0.6/0/backbone_best.tar'
ckpt_cls_head = r'/data/chenrj/semi-order-time/ckpt/exp-TSC/SemiSOP/EpilepticSeizure/magnitude_warp_time_warp/label1_0.6/0/classification_head_best.tar'
