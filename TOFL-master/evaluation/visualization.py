...
if model == 'SemiCOP':
    ckpt_backbone = r'/data/chenrj/semi-order-time/ckpt/exp-TSC/SemiSOP/CricketX/magnitude_warp_time_warp/label1_0.5/1/backbone_best.tar'
    ckpt_cls_head = r'/data/chenrj/semi-order-time/ckpt/exp-TSC/SemiSOP/CricketX/magnitude_warp_time_warp/label1_0.5/1/classification_head_best.tar'
else:
    ckpt_backbone = r'/data/chenrj/semi-order-time/ckpt/exp-TSC/supervised/CricketX/magnitude_warp_time_warp/label1/1/backbone_best.tar'
    ckpt_cls_head = r'/data/chenrj/semi-order-time/ckpt/exp-TSC/supervised/CricketX/magnitude_warp_time_warp/label1/1/classification_head_best.tar'
